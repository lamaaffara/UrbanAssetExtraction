...
cd(fileparts(which('acfDemoCal.m'))); dataDir='D:\Image Datasets\INRIA\code3.2.1\data-INRIA\data\';
for s=1:2
  if(s==1), type='test'; skip=[]; else type='train'; skip=4; end
  dbInfo(['Inria' type]); if(s==2), type=['train' int2str2(skip,2)]; end
